  ...
  return (
    <div className="relative h-screen flex flex-col overflow-hidden">
      ...
      <header
        ...
        className="h-16 relative z-10 shrink-0 flex items-center gap-8 px-8 border-b border-border-default backdrop-blur-md bg-bg-glass"
      >
      ...
      <footer
        ...
        className="h-14 relative z-1 shrink-0 flex items-center justify-between px-8 border-t border-border-default text-xs text-text-muted"
      >
